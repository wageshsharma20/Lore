...
import { getHeatmapModules } from '@/lib/api';
  ...
  return (
    <main className="p-8 max-w-6xl mx-auto min-h-[80vh] flex flex-col justify-start">
      ...
      {isLoading ? (
        ...
        <div className="p-12 text-center bg-gray-50 border border-dashed border-gray-300 w-full rounded-xl">
          <div className="w-16 h-16 bg-blue-100 text-blue-600 flex items-center justify-center mx-auto mb-6 rounded-full">
